...
class CartScreen extends StatelessWidget {
  ...
  Future<void> _placeOrder(BuildContext context) async {
    ...
    try {
      ...
      final totalText = total is num ? ' • Total: £${total.toStringAsFixed(2)}' : '';
  ...
  Widget build(BuildContext context) {
    ...
    final totalAmount = items.fold<num>(0, (sum, item) => sum + (item.product.price * item.quantity));
                          ...
                          child: Row(
                            ...
                            children: [
                              SizedBox(
                                ...
                                height: 56,
                                child: ProductImage(
                                  assetName: item.product.imageUrl,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        Text('Line total: £${lineTotal.toStringAsFixed(2)}'),
                                      ],
                                    ),
                                  ],
                                ),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const Spacer(),
                            Text('£${totalAmount.toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.w700)),
                          ],
                        ),
